...
public class SwaggerConfig {
    ...
    public ApiInfo createAI() {
        ApiInfo apiInfo = new ApiInfoBuilder().title("家有爱车的后端接口文档").
                description("家有爱车的主站的项目的所有接口信息，可以查看对应的接口信息和对接口进行测试").
                contact(new Contact("第4组", "http://www.autohome.com.cn", "aicar@163.com")).build();
        return apiInfo;
    }
