...
public class EncryptUtil {
    ...
    public static void main(String[] args) {
        ...
        String aesPwd = aesenc(aesKey, pss);
        String password = aesdec(aesKey, aesPwd);
        System.out.println("aesPwd = " + aesPwd);
        System.out.println("password = " + password);

        // RSA 加密
        HashMap<String, String> rsaKey = EncryptUtil.createRSAKey();
        System.out.println("rsaKey.get(EncryptUtil.PUBKEY) = " + rsaKey.get(EncryptUtil.PUBKEY));
        System.out.println("rsaKey.get(EncryptUtil.PRIKEY) = " + rsaKey.get(EncryptUtil.PRIKEY));
        String p = EncryptUtil.rsaEnc(rsaKey.get(EncryptUtil.PRIKEY), pss);
        System.out.println("123456 密文 = " + p);
        String s = EncryptUtil.rsaDec(rsaKey.get(EncryptUtil.PUBKEY), p);
        System.out.println("密文解析结果 = " + s);
    }
}