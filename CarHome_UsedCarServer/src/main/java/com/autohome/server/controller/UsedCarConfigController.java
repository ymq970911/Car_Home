...
public class UsedCarConfigController {
    ...
    public R addUsedCarConfig(@PathVariable Integer cid, @PathVariable Integer uid) {
        return service.insertUsedCarConfig(cid, uid, new LicencePlate());
    }
     ...
     * @return
     */
    @PostMapping("/del/{cid}/{uid}/{uniqueId}")
     ...
     * @return R
     */
    @GetMapping(value = {"/getdetail/{uid}/{cid}", "/getdetail/{uid}"})
