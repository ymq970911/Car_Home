...
public class UsedCarController {
    ...
    @PostMapping("/publish/{uid}/{cid}/{uniqueId}")
    ...
    @GetMapping(value = {"/getuser/{uid}","/getuser/{uid}/{cid}","/getiser/{uid}/{cid}/{uniqueId}"})
